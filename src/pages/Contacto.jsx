    ...
    <><main className="main-cont">
      ...
      <fieldset className="information">
        ...
        <div className="information__personal">
          <div className="title"><label htmlFor="lbl-name">Nombre:*</label></div>
          <input type="text" id="lbl-name" required />
        </div>
        <div className="information__personal">
          <div className="title"><label htmlFor="lbl-lastname">Apellido:*</label></div>
      ...
      <fieldset className="contact">
        ...
        <div className="contac__contact-information">
          <div className="title"><label htmlFor="lbl-tel">Teléfono:</label></div>
          <input
            className="input"
            type="text"
            id="lbl-tel"
