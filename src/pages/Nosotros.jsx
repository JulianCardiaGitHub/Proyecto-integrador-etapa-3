...
const Nosotros = () => {
  ...
  return (
    <><h2 className="welcome">Bienvenidos a Vision Digital Technology</h2><main className="main-us">
      ...
      <section>
        <div className="mission">
          <p><b>Misión</b> En Vision Digital Technology nos dedicamos a ofrecer
          ...
          <p>
            <b>Visión</b> Nos esforzamos por ser líderes en el mercado de
          ...
          <p>
            <b>Servicios </b>En Vision Digital Technology, ofrecemos una amplia
          ...
          <ul className="list-o">
            <li>
              <p>
                <b>Reparación de Computadoras:</b> Nuestro equipo de técnicos
            ...
            <li>
              <p>
                <b>Venta de Insumos Tecnológicos:</b> Contamos con una selección
            ...
            <li>
              <p>
                <b>Asesoramiento Técnico:</b> Nuestro equipo está siempre
          ...
          <p>
            <b>Compromiso con la Calidad</b> En Vision Digital Technology, nos
        ...
        <div className="tres-maps">
          ...
          <div className="map1">
            ...
            <iframe className="vd1" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1949.003651109338!2d-58.20917932542738!3d-34.76011759990856!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x95a32f490c329f7d%3A0x4c16b5132584fb3d!2s(COMPUTACI%C3%93N%2C%20INFORM%C3%81TICA%2C%20REPARACIONES)%20........VISI%C3%93N%20DIGITAL.......!5e0!3m2!1ses!2sar!4v1717878534749!5m2!1ses!2sar" width="400" height="300" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
          </div>
          <div className="map2">
            <p className="p-map">Berazategui-oeste</p>
            <iframe className="vd2" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d819.3472203705317!2d-58.22692463036015!3d-34.77098419667119!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x95a32f2cd83cf8a5%3A0xedb26d51e8c37c2!2sAv.%20Rigolleau%203171%2C%20B1884CTF%20Berazategui%2C%20Provincia%20de%20Buenos%20Aires!5e0!3m2!1ses!2sar!4v1717878959674!5m2!1ses!2sar" width="400" height="300" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
          </div>
          <div className="map3">
            <p className="p-map">Ezpeleta-Centro</p>
            <iframe className="vd3" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2756.5708282794076!2d-58.23776113741979!3d-34.75222617665462!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x95a32ee031c7965f%3A0xaaa43626d92c18bf!2sVisi%C3%B3n%20Digital!5e0!3m2!1ses!2sar!4v1717878899900!5m2!1ses!2sar" width="400" height="300" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
          </div>
        </div>
      </section>
    </main></>
